...
import static com.example.ecookbook.PrintSteps.yoghurtSoupSteps;

import com.example.ecookbook.TreeNode;


public class yoghurtController {

    @FXML
    private TextArea yoghurtText;
    @FXML
    private TextArea yoghurtIngredientText;

    @FXML
    void yoghurtRecipe(MouseEvent event) {

        yoghurtText.appendText(yoghurtSoupSteps());
    }

    @FXML
    void yoghurtIngredients(MouseEvent event) {
        ...
        String yoghurtIngredients = yoghurtSoupTree.printIngredients();

        yoghurtIngredientText.appendText(yoghurtIngredients);
    }
