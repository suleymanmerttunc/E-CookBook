...
import static com.example.ecookbook.PrintSteps.lentilSoupSteps;

import com.example.ecookbook.TreeNode;


public class lentilController {

    @FXML
    private TextArea lentilText;
    @FXML
    private TextArea lentilIngredientText;

    @FXML
    void lentilRecipe(MouseEvent event) {

        lentilText.appendText(lentilSoupSteps());
    }

    @FXML
    void lentilIngredients(MouseEvent event) {
        ...
        String lentilIngredients = lentilSoupTree.printIngredients();

        lentilIngredientText.appendText(lentilIngredients);
    }
