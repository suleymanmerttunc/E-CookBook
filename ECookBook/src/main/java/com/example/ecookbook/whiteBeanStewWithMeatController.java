...
import static com.example.ecookbook.PrintSteps.whiteBeanStewWithMeatSteps;

import com.example.ecookbook.TreeNode;


public class whiteBeanStewWithMeatController {

    @FXML
    private TextArea whiteBeanStewWithMeatText;
    @FXML
    private TextArea whiteBeanStewWithMeatIngredientText;

    @FXML
    void whiteBeanStewWithMeatRecipe(MouseEvent event) {

        whiteBeanStewWithMeatText.appendText(whiteBeanStewWithMeatSteps());
    }

    @FXML
    void whiteBeanStewWithMeatIngredients(MouseEvent event) {
        ...
        String whiteBeanStewWithMeatIngredients = whiteBeanStewWithMeatTree.printIngredients();

        whiteBeanStewWithMeatIngredientText.appendText(whiteBeanStewWithMeatIngredients);
    }
