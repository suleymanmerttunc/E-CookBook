...
public class mucverController {

    @FXML
    private TextArea mucverText;
    @FXML
    private TextArea mucverIngredientText;

    @FXML
    void mucverRecipe(MouseEvent event) {

        mucverText.appendText(mucverSteps());
    }

    @FXML
    void mucverIngredients(MouseEvent event) {
        AVLTree mucverTree = new AVLTree();
        mucverTree.root = mucverTree.insert(mucverTree.root, "zucchini");
        mucverTree.root = mucverTree.insert(mucverTree.root, "carrot");
        mucverTree.root = mucverTree.insert(mucverTree.root, "egg");
        mucverTree.root = mucverTree.insert(mucverTree.root, "flour");
        mucverTree.root = mucverTree.insert(mucverTree.root, "fresh onions");
        mucverTree.root = mucverTree.insert(mucverTree.root, "dill");
        mucverTree.root = mucverTree.insert(mucverTree.root, "salt");
        mucverTree.root = mucverTree.insert(mucverTree.root, "black pepper");
        mucverTree.root = mucverTree.insert(mucverTree.root, "oil ");

        String mucverIngredients = mucverTree.printIngredients();

        mucverIngredientText.appendText(mucverIngredients);
    }
