...
import static com.example.ecookbook.PrintSteps.tarhanaSoupSteps;

import com.example.ecookbook.TreeNode;


public class tarhanaController {

    @FXML
    private TextArea tarhanaText;
    @FXML
    private TextArea tarhanaIngredientText;

    @FXML
    void tarhanaRecipe(MouseEvent event) {

        tarhanaText.appendText(tarhanaSoupSteps());
    }

    @FXML
    void tarhanaIngredients(MouseEvent event) {
        ...
        String tarhanaIngredients = tarhanaSoupTree.printIngredients();

        tarhanaIngredientText.appendText(tarhanaIngredients);
    }
