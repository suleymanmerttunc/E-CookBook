...
public class zucchiniStewController {

    @FXML
    private TextArea zucchiniStewText;
    @FXML
    private TextArea zucchiniStewIngredientText;

    @FXML
    void zucchiniStewRecipe(MouseEvent event) {

        zucchiniStewText.appendText(zucchiniStewSteps());
    }

    @FXML
    void zucchiniStewIngredients(MouseEvent event) {
        ...
        String zucchiniStewIngredients = zucchiniStewTree.printIngredients();

        zucchiniStewIngredientText.appendText(zucchiniStewIngredients);
    }
