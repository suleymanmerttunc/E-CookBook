...
public class sarmaController {

    @FXML
    private TextArea sarmaText;
    @FXML
    private TextArea sarmaIngredientText;

    @FXML
    void sarmaRecipe(MouseEvent event) {

        sarmaText.appendText(sarmaSteps());
    }

    @FXML
    void sarmaIngredients(MouseEvent event) {
        ...
        String sarmaIngredients = yaprakSarmaTree.printIngredients();

        sarmaIngredientText.appendText(sarmaIngredients);
    }
