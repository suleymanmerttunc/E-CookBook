...
public class cauliflowerWithOliveOilController {

    @FXML
    private TextArea cauliflowerWithOliveOilText;
    @FXML
    private TextArea cauliflowerWithOliveOilIngredientText;

    @FXML
    void cauliflowerWithOliveOilRecipe(MouseEvent event) {

        cauliflowerWithOliveOilText.appendText(cauliflowerWithOliveOilSteps());
    }

    @FXML
    void cauliflowerWithOliveOilIngredients(MouseEvent event) {
        ...
        String cauliflowerWithOliveOilIngredients = cauliflowerWithOliveOilTree.printIngredients();

        cauliflowerWithOliveOilIngredientText.appendText(cauliflowerWithOliveOilIngredients);
    }
