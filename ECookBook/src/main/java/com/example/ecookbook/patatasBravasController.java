...
import static com.example.ecookbook.PrintSteps.patatasBravasSteps;

import com.example.ecookbook.TreeNode;


public class patatasBravasController {

    @FXML
    private TextArea patatasBravasText;
    @FXML
    private TextArea patatasBravasIngredientText;

    @FXML
    void patatasBravasRecipe(MouseEvent event) {

        patatasBravasText.appendText(patatasBravasSteps());
    }

    @FXML
    void patatasBravasIngredients(MouseEvent event) {
        AVLTree patatasBravasTree = new AVLTree();
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "potatoes");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "olive oil");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "onion");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "garlic");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "ground chili pepper");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "tomatoes");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "mayonnaise");
        patatasBravasTree.root = patatasBravasTree.insert(patatasBravasTree.root, "vinegar");

        String patatasBravasIngredients = patatasBravasTree.printIngredients();

        patatasBravasIngredientText.appendText(patatasBravasIngredients);
    }
