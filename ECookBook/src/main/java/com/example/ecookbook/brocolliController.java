...
import static com.example.ecookbook.PrintSteps.broccoliSoupSteps;
import static com.example.ecookbook.PrintSteps.falafelSteps;
import com.example.ecookbook.TreeNode;


public class brocolliController {

    @FXML
    private TextArea brocolliText;
    @FXML
    private TextArea brocolliIngredientText;

    @FXML
    void brocolliRecipe(MouseEvent event) {

        brocolliText.appendText(broccoliSoupSteps());
    }

    @FXML
    void brocolliIngredients(MouseEvent event) {
        ...
        String brocolliIngredients = broccoliSoupTree.printIngredients();

        brocolliIngredientText.appendText(brocolliIngredients);
    }
